      ...
      def self.criar_transferencia(params)
        ...
        db.transaction do
          ...
          saida_id = table.insert(
            ...
            descricao: "Transferência para #{conta_destino[:banco]} (#{conta_destino[:apelido]}) - #{empresa_destino&.[](:nome_fantasia) || 'N/A'}",
            valor_bruto: valor,
            valor_liquido: valor,
            lucro: 0,
          ...
          entrada_id = table.insert(
            ...
            data_movimentacao: data,
            data_competencia: data,
            descricao: "Transferência de #{conta_origem[:banco]} (#{conta_origem[:apelido]}) - #{empresa_origem&.[](:nome_fantasia) || 'N/A'}",
            valor_bruto: valor,
            valor_liquido: valor,
            lucro: 0,
            tipo_operacao: 'transferencia',
